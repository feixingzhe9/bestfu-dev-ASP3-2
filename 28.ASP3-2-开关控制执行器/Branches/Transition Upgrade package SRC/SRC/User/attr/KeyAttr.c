...
{
    {0x01, LEVEL_1, NULL                            ,Get_TouchKeyAction_Attr         },
    {0x02, LEVEL_1, Set_TouchKeyState_Attr          ,Get_TouchKeyState_Attr          },
    {0x03, LEVEL_1, NULL                            ,Get_TouchKeyAction_Attr         },
    {0x04, LEVEL_1, Set_TouchKeyState_Attr          ,Get_TouchKeyState_Attr          }, 
	{0x05, LEVEL_1, NULL                            ,Get_TouchKeyAction_Attr         },
    {0x06, LEVEL_1, Set_TouchKeyState_Attr          ,Get_TouchKeyState_Attr          },
    {0x07, LEVEL_0, Set_RelayBangdingKey_Attr_One   ,Get_RelayBangdingKey_Attr_One   },
    {0x08, LEVEL_0, Set_RelayBangdingKey_Attr_Two   ,Get_RelayBangdingKey_Attr_Two   },
    {0x09, LEVEL_0, Set_LEDLogicState_Attr_One      ,Get_LEDLogicState_Attr_One      },
    {0x0a, LEVEL_0, Set_LEDLogicState_Attr_Two      ,Get_LEDLogicState_Attr_Two      },
};

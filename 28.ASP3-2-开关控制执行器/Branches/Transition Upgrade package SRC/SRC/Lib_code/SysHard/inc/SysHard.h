...
//EEPROM IIC通信接口
#define SCL_PORT    GPIO_B      //SCL端口   //PB6
#define SCL_PIN    	pin_6     	//SCL引脚 
													    
#define SDA_PORT    GPIO_B      //SDA端口   //PB7
#define SDA_PIN     pin_7      	//SDA引脚
#define EEPROM_WP		1 //EEPROM写保护; 1: 有写使能保护管脚，0：无写使能保护管脚
#if EEPROM_WP
	#define WP_PORT			GPIO_B	 //Write Protect port  //PB5
...
#if HardWDG
	#define	WDG_PORT	GPIO_A		 //硬件喂狗端口   //PA12
...
#define SDN_PORT        GPIO_B	//433复位端口    //PB11
#define SDN_PIN         pin_11	//433复位引脚

#define nIRQ_PORT       GPIO_B  //数据中断端口  注意：中断IO修改后需要修改内部的一些配置   //PB10
#define nIRQ_PIN        pin_10	//数据中断引脚

#define nSEL_PORT       GPIO_B  //SPI片选端口    //PB12

...
const Unit_st UnitTab[] = 
{
    ...
    {SwitchAttr_Init    , SwitchAttrEEPROM_Init , SWActInstruct    , (AttrExe_st*)SwitchAttrTable   ,Switch_UnitAttrNum},  
    {SwitchAttr_Init    , SwitchAttrEEPROM_Init , SWActInstruct    , (AttrExe_st*)SwitchAttrTable   ,Switch_UnitAttrNum},  
    {KeyAttr_Init    	, KeyEepromInit         , SWActInstruct    , (AttrExe_st*)KeyAttrTable    	,Key_UnitAttrNum   }  
};
